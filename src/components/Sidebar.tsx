      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900/60 p-3">
        ...
        <div className="space-y-2.5">
          ...
          <div className="flex items-center gap-2 pt-1 border-t border-slate-800/70">
            <span className="w-8 text-[11px] font-mono font-semibold text-slate-500">
              {t.sidebar.others}
            </span>
            ...
            <div className="space-y-3 border-t border-slate-800 px-3 py-3">
              <div>
                ...
                <div className="mt-0.5 flex justify-between text-[9px] text-slate-600">
                  <span>{t.sidebar.w25Left}</span>
                  <span>{t.sidebar.w25Right}</span>
                </div>
              </div>
              <div>
                <div className="mb-1 flex justify-between text-[11px] text-slate-400">
                  <span>{t.sidebar.sigma}</span>
              ...
              <div>
                <div className="mb-1 flex justify-between text-[11px] text-slate-400">
                  <span>{t.sidebar.iterations}</span>
...
function PartySlider({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      />
      <Badge
        variant={above ? "ok" : "danger"}
        className="w-[76px] justify-center"
        title={above ? t.detPanel.inSejm : t.detPanel.outSejm}
      >
        {above ? `${t.badge.threshold} ≥${thr}%` : `<${thr}%`}
      </Badge>
    </div>
  );
}
